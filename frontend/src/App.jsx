    ...
    <div className="min-h-screen bg-[#0d0d0d] text-white relative overflow-hidden font-sans">
      ...
      <header className="bg-[#1e1e1e] py-5 px-8 flex items-center justify-between shadow-lg">
        ...
        <div className="space-x-4">
          <Link
            to="/register"
            className="inline-block border border-[#ffa116] text-[#ffa116] px-5 py-2 rounded hover:bg-yellow-600 hover:text-black transition"
          >
            Register
          </Link>
          <Link
            to="/login"
            className="inline-block bg-[#ffa116] text-black px-5 py-2 rounded hover:bg-yellow-700 transition"
          >
            Login
          </Link>
        </div>
      ...
      <div className="border-t border-[#ffa116] mt-[-1px] shadow-[0_0_10px_rgba(255,193,7,0.4)]"></div>
      ...
      <section className="flex flex-col justify-center items-center text-center h-[calc(100vh-90px)] px-4">
        ...
        <div className="mt-10 space-x-4">
          <Link
            to="/register"
            className="bg-[#ffa116] text-black font-semibold px-8 py-3 rounded hover:bg-yellow-700 transition"
          >
            Get Started
          </Link>
        </div>
