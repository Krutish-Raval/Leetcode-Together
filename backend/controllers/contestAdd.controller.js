...
const addContest= asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,{contestType,contestId,date},"contest added successfully"));
})
...
const removeContest =asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,{contestId},"contest removed successfully"));
})
...
const populateContests =asyncHandler( async (req, res) => {
        ...
        return res.status(200).json(new ApiResponse(200,"populate successfully",contests.length ));
    })
